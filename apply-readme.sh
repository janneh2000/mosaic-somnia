#!/usr/bin/env bash
# Overwrites README.md with the polished hackathon-submission version.
# Backs up the previous version as README.md.bak.
set -euo pipefail

REPO="${REPO:-$HOME/Desktop/mosaic-somnia/mosaic}"
DEST="$REPO/README.md"
[ -f "$DEST" ] || { echo "✗ $DEST not found"; exit 1; }
...
echo "✓ overwrote $DEST (previous version backed up to README.md.bak)"
echo
echo "Preview locally:"
echo "  open -R $DEST"
echo "  # or render in VS Code: Cmd+Shift+V"
echo
echo "Then commit and push:"
echo "  cd $REPO"
echo "  git add README.md"
echo "  git diff --cached README.md   # review before committing"
echo "  git commit -m \"docs: polish README for hackathon submission\""
echo "  git push"
